...
from main.forms import ProjectEntryForm
...
def create_project_entry(request):
        form = ProjectEntryForm(request.POST or None)
...
def show_xml_by_id(request, id):
    data_id = Project.objects.filter(pk=id)  # Use the id argument passed to the function
